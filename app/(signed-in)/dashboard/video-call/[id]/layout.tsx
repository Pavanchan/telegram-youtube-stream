...
function Layout({ children }: { children: React.ReactNode }) {
  ...
  /**
   * -----------------------------------------------------
   * Client loading state (Initializing client…)
   * -----------------------------------------------------
   */
  if (!client) {
    return (
  ...
  /**
   * -----------------------------------------------------
   * Call loading state (Joining call…)
   * -----------------------------------------------------
   */
  if (!call) {
    return (
      ...
      >
        <div className="animate-bounce w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto">
